  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">Yangtze</a>
        <a class="site-navbar__brand-mini" href="javascript:;">Yangtze</a>
      </h1>
    </div>
    ...
    methods: {
      ...
      logoutHandle () {
        this.$confirm(`确定进行[退出]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/api/v1/user/logout'),
            method: 'post',
